...
public class DigitalCertificateIOTest {
    ...
    public void testFileIsDirectory_SaveDC() throws IOException {
        ...
        DigitalCertificateIO.writeDigitalCertificate(cert, regularDir.getAbsolutePath());
    }
    ...
    public void testNoWriteAccessToLocation_SaveDC() throws IOException {
        ...
        DigitalCertificateIO.writeDigitalCertificate(cert, fullTempFilePath);
    ...
    public void testFileIsDirectory_readDigitalCertificate() throws IOException, ClassNotFoundException {
        ...
        DigitalCertificateIO.readDigitalCertificate(regularDir.getAbsolutePath());
    }
    ...
    public void testNoReadAccess_readDigitalCertificate() throws IOException, ClassNotFoundException {
        ...
        DigitalCertificateIO.writeDigitalCertificate(cert, tempFile);
        File f = new File(tempFile);
        f.setReadable(false, false);
        f.deleteOnExit();

        //Saving should not be an issue.
        DigitalCertificateIO.readDigitalCertificate(tempFile);
    }
    ...
    public void testInvalidSerializedCertificate_readDigitalCertificate() throws IOException, ClassNotFoundException {
        ...
        DigitalCertificateIO.readDigitalCertificate(f.getAbsolutePath());
    }
    ...
    public void testNominalCase_readDigitalCertificate() throws IOException, ClassNotFoundException {
        ...
        DigitalCertificateIO.writeDigitalCertificate(cert, f.getAbsolutePath());

        DigitalCertificate cert2 = DigitalCertificateIO.readDigitalCertificate(f.getAbsolutePath());
    ...
    @Test(expected = NullPointerException.class)
    public void testNullFilename_readDigitalCertificate() {
        try {
            //This call should throw the unexpected NullPointerException
            DigitalCertificateIO.readDigitalCertificate(null);
        } catch (IOException e) {
            fail("IOException was not the expected thrown exception.");
        } catch (ClassNotFoundException e) {
            fail("ClassNotFoundException was not the expected thrown exception.");
        }
    }
