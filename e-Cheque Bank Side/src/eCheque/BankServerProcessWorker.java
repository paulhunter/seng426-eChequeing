 ...
 * institute's server. The process will handle all network IO and terminate after
...
public class BankServerProcessWorker implements Runnable {
     ...
     * @throws Exception if any of the operations needed to complete the transaction
     * fail.
     */
     ...
     * deposit. 
     * @throws IOException Networking Failure.
     * @throws ClassNotFoundException the information received from the client did 
    ...
    /**
     * Cancal a cheque that was previously created. Making it impossible to cash
     * by the individual it was created for. 
     * @throws IOException Networking Failure.
     * @throws ClassNotFoundException Information received from the client was not
    ...
    /**
     * After the communication is complete for the operation that the client wants
     * to carry out this method should be called to close all the appropriate socket
     * objects for input and output. No exceptions will be thrown from this 
     * method, it will handle the exceptions as needed. 
     */
    ...
    /**
     * Entry method for the worker process. This is the method that should be used
     * to star a working thread from within the BankServer process/application.
     */
    public void RunServer() {
        try {
            ...
            //Unable to retrieve socket connection
            //likely that the client disconnected.
            //TODO: provide this information somewhere.
